        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-14 ">
            ...
            <div class="sm:col-span-2 lg:col-span-1 ">
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    <span class="font-display font-semibold text-[15px] text-white">
                        {{ config('app.name') }}
                    </span>
                </div>
                <p class="text-sm leading-relaxed opacity-50 mb-6 max-w-[200px]">
                    Building world-class web experiences that create lasting results for people and teams.
                </p>
                {{-- Social links --}}
                <div class="flex items-center gap-2.5">
                    ...
                    <a href="{{ $href }}" target="_blank" rel="noopener noreferrer"
                       aria-label="{{ $name }}"
                       class="w-8 h-8 rounded-lg border border-white/10 flex items-center justify-center
                              text-zinc-500 hover:text-white hover:border-white/25
            ...
            {{-- Navigation --}}
            <div>
                <h4 class="font-mono text-[10px] font-semibold uppercase tracking-[0.12em]
                           text-zinc-600 dark:text-zinc-700 mb-5">
                    Navigation
                </h4>
                <ul class="space-y-3">
                    @foreach([
            ...
            <div>
                ...
                <p class="text-sm text-zinc-500 leading-relaxed mb-5">
                    Get updates on new projects and articles delivered to your inbox.
                </p>
