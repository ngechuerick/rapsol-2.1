<footer class="bg-zinc-900 dark:bg-zinc-950 text-zinc-500 dark:text-zinc-400 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 md:px-6 border-l border-r border-dashed border-zinc-600 dark:border-zinc-800">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-14">
            ...
            <div>
                <h4
                    class="font-mono text-xs font-semibold uppercase tracking-[0.12em] text-zinc-600 dark:text-zinc-700 mb-5"
                >
                    Navigation
                </h4>
                <ul class="space-y-2">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 py-6 border-t border-white/6">
            ...
            <div class="flex items-center gap-5">
                <a
                    href="/privacy"
                    class="text-xs text-zinc-500 hover:text-zinc-500 dark:text-zinc-400 transition-colors"
                    >Privacy</a
                >
                <a href="/terms" class="text-xs text-zinc-500 hover:text-zinc-500 dark:text-zinc-400 transition-colors"
                    >Terms</a
                >
                <span href="/cookie-policy" class="font-mono text-xs text-zinc-500 dark:text-zinc-400"> cookies</span>
            </div>
        </div>
    </div>
</footer>
