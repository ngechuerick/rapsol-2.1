...
>
    <div class="max-w-7xl mx-auto">
        ...
        >
            ...
            <a
                href="/"
                class="flex items-center gap-2.5 font-display font-semibold text-[15px] text-zinc-900 dark:text-white transition-colors duration-300 shrink-0"
            >
                <div
                    class="w-6 h-6 rounded-md flex items-center justify-center shrink-0 bg-zinc-900 dark:bg-white transition-colors duration-300"
                >
