<section class="relative border-t border-zinc-200 dark:border-zinc-800 overflow-hidden bg-zinc-900 dark:bg-zinc-950">
    ...
    <div class="relative px-7 py-20 text-center" data-animate>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
                href="/contact"
                class="inline-flex items-center gap-2 px-7 py-3.5 rounded-lg font-display font-semibold text-sm border border-zinc-700 hover:border-zinc-500 text-zinc-300 hover:text-white transition-all duration-200 hover:-translate-y-0.5"
            >
                Get in touch
            </a>
        </div>
