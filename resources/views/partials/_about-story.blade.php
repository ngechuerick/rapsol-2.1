    ...
    <div class="px-7 py-16 grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-14 items-center">
        ...
        <div class="relative" data-animate data-delay="2">
            <div class="relative aspect-4/5 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                ...
                >
                    <div
                        class="absolute inset-0 opacity-40 bg-[linear-gradient(rgba(217,119,6,0.15)_1px,transparent_1px),linear-gradient(90deg,rgba(217,119,6,0.15)_1px,transparent_1px)] bg-size-[28px_28px]"
                    ></div>
                ...
                >
                    <div class="font-display font-bold text-sm text-white">Our Nairobi HQ</div>
                    <div class="text-xs text-white/50 mt-0.5">Westlands, Nairobi · 2024</div>
                </div>
            </div>
            <div class="absolute -top-1.25 -left-1.25 w-2.5 h-2.5 rotate-45 bg-amber-500 z-20"></div>
            <div class="absolute -bottom-1.25 -right-1.25 w-2.5 h-2.5 rotate-45 bg-amber-500 z-20"></div>
        </div>
    </div>
</section>
