...
<section id="services" class="relative border-t border-shark-200 dark:border-shark-800">
    ...
    <div class="px-7 pt-16 pb-10" data-animate>
        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <p class="text-base text-shark-600 dark:text-shark-400 max-w-xs leading-relaxed md:text-right">From digital products to technical strategy one firm, complete capability.</p>
        </div>
    </div>
